                            ...
                            <div class="row">
                                <div class="col-sm-6" style="padding-top: 7px;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nombre" id="nombre" value="<?= $unidad['nombre']; ?>" autofocus required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6" style="padding-top: 7px;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nombre_corto" id="nombre_corto" value="<?= $unidad['nombre_corto']; ?>" required>
                                    </div>
                                </div>
                            </div>
