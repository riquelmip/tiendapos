        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <p>
                            <a href="<?= base_url();?>/cajas" class="btn btn-primary">Cajas</a>
                        </p>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    <a href="#" data-href="<?= base_url('/cajas/reingresar/'.$caja['id'])?>"  data-bs-toggle="modal" data-bs-target="#modal-confirm" data-placement="top" title="Reingresar registro" class="btn btn-info"><i class="fa fa-arrow-up"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php }?>
